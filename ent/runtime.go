...
func init() {
	...
	userDescIDCard := userFields[5].Descriptor()
	// user.IDCardValidator is a validator for the "id_card" field. It is called by the builders before save.
	user.IDCardValidator = userDescIDCard.Validators[0].(func(string) error)
