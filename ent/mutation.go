...
func (m *UserMutation) SetDateOfBirth(s string) {
	m.date_of_birth = &s
}

// DateOfBirth returns the value of the "date_of_birth" field in the mutation.
func (m *UserMutation) DateOfBirth() (r string, exists bool) {
	v := m.date_of_birth
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldDateOfBirth(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// OldMemberCard returns the old "member_card" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldMemberCard(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) AddMemberCard(i int) {
...
func (m *UserMutation) AddedMemberCard() (r int, exists bool) {
	v := m.addmember_card
	if v == nil {
		return
	}
...
func (m *UserMutation) ResetMemberCard() {
	m.member_card = nil
	m.addmember_card = nil
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.member_card != nil {
		fields = append(fields, user.FieldMemberCard)
	}
	if m.created_at != nil {
