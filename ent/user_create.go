...
func (uc *UserCreate) SetDateOfBirth(s string) *UserCreate {
	uc.mutation.SetDateOfBirth(s)
	return uc
}

// SetMemberCard sets the "member_card" field.
func (uc *UserCreate) SetMemberCard(i int) *UserCreate {
	uc.mutation.SetMemberCard(i)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.IDCard(); !ok {
		return &ValidationError{Name: "id_card", err: errors.New(`ent: missing required field "User.id_card"`)}
	}
	if v, ok := uc.mutation.IDCard(); ok {
	...
	if _, ok := uc.mutation.DateOfBirth(); !ok {
		return &ValidationError{Name: "date_of_birth", err: errors.New(`ent: missing required field "User.date_of_birth"`)}
	}
	if _, ok := uc.mutation.MemberCard(); !ok {
		return &ValidationError{Name: "member_card", err: errors.New(`ent: missing required field "User.member_card"`)}
	}
	if _, ok := uc.mutation.CreatedAt(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.MemberCard(); ok {
